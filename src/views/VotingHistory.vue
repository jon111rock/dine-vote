...
<template>
  <div ref="scrollContainerRef" class="voting-history-page pb-16">
    <!-- 固定在頂部的導航 -->
    <div class="fixed top-0 left-0 right-0 bg-gradient-to-b from-gray-100 to-transparent backdrop-blur-sm z-10 p-4">
      <NavigationBack title="投票紀錄" />
    </div>

    <div class="pt-20 px-4 max-w-3xl mx-auto"> <!-- 增加 pt 以避開固定導航 -->
