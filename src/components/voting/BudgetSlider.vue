...
<template>
  <div>
    ...
    <input type="range" :min="min" :max="max" :step="step" :value="modelValue" @input="handleInput" class="w-full mt-2 h-2 appearance-none bg-gray-200 rounded-full cursor-pointer" />
